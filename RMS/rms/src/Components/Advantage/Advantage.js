			...
			<div className={s.global_wrapper}>
				...
				<div className={s.adv_wrapper}>
					...
					{/*	/!*<Divider type="vertical" className={s.antDividerVertical}/>*!/*/}
						<div className={s.content_block__item}>
							<span className={s.item_num}>50<span className={s.item_num__perc}>%</span></span>
							<span className={s.item_txt}>Рост продаж <br/>с сайта</span>
						</div>
					{/*	/!*<Divider type="vertical" className={s.antDividerVertical}/>*!/*/}
						<div className={s.content_block__item}>
							<span className={s.item_num}>75<span className={s.item_num__perc}>%</span></span>
							<span className={s.item_txt}>Улучшение имиджа компании</span>
						</div>
					{/*	/!*<Divider type="vertical" className={s.antDividerVertical}/>*!/*/}
						<div className={s.content_block__item}>
							<span className={s.item_num}>36<span className={s.item_num__perc}>%</span></span>
