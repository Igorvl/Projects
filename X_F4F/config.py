...
DAILY_LIKE_LIMIT = 30          # Безопасный лимит целевых лайков в сутки (оставляет квоту под ручную активность)
LIKE_PROBABILITY = 0.75        # Лайкаем работу в ~75% случаев (органично, без ощущения конвейера)
