...
# ==========================================
DAILY_FOLLOW_LIMIT = 65        # Режим высокой эффективности: 65 подписок в сутки (размазаны на 12-14 сессий)
DAILY_UNFOLLOW_LIMIT = 65      # Соответствующий лимит отписок
DAILY_LIKE_LIMIT = 130         # Полноценный Tri-Touch каскад (по 2 лайка) на всех кандидатов (лимит X: 1000/день)
LIKE_PROBABILITY = 0.90        # Высокая вероятность теплого касания
MIN_DELAY_SECONDS = 25         # Минимальная пауза между целями
MAX_DELAY_SECONDS = 65         # Максимальная случайная пауза
