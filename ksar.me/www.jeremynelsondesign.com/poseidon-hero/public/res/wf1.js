(self.webpackChunk = self.webpackChunk || []).push([["928"], {
    5487: function () {
        ...
        window.tram = function (e) {
            ...
            var u, l, c, s = function (e, t, n) {
                    ...
                    return function o(u, l) {
                        ...
                        var d, f = a[e] = u[e], p = s[e] = c[e] = new a;
                        return p.constructor = c, c.mixin = function (t) {
                            return s[e] = c[e] = o(c, t)[e], c
                        }, c.open = function (e) {
                            if (d = {}, r(e) ? d = e.call(c, p, f, c, u) : i(e) && (d = e), i(d)) for (var n in d) t.call(d, n) && (p[n] = d[n]);
                ...
                }, p = window, g = "bkwld-tram", h = /[\-\.0-9]/g, E = /[A-Z]/, m = "number", y = /^(rgb|#)/,
                v = /(em|cm|mm|in|pt|pc|px)$/, I = /(em|cm|mm|in|pt|pc|px|%)$/, b = /(deg|rad|turn)$/, _ = "unitless",
                T = /(all|none) 0s ease 0s/, O = /^(width|height)$/, w = document.createElement("a"),
                A = ["Webkit", "Moz", "O", "ms"], S = ["-webkit-", "-moz-", "-o-", "-ms-"], C = function (e) {
                    if (e in w.style) return {dom: e, css: e};
                    var t, n, i = "", r = e.split("-");
                    for (t = 0; t < r.length; t++) i += r[t].charAt(0).toUpperCase() + r[t].slice(1);
                    for (t = 0; t < A.length; t++) if ((n = A[t] + i) in w.style) return {dom: n, css: S[t] + e}
                }, R = t.support = {
            ...
            if (R.transition) {
                var N = R.timing.dom;
                if (w.style[N] = d["ease-in-back"][0], !w.style[N]) for (var L in f) d[L][0] = f[L]
            }
            var F = t.frame = (u = p.requestAnimationFrame || p.webkitRequestAnimationFrame || p.mozRequestAnimationFrame || p.oRequestAnimationFrame || p.msRequestAnimationFrame) && R.bind ? u.bind(p) : function (e) {
                ...
                P = t.now = (c = (l = p.performance) && (l.now || l.webkitNow || l.msNow || l.mozNow)) && R.bind ? c.bind(l) : Date.now || function () {
                    return +new Date
                }, M = s(function (t) {
                    function n(e, t) {
                        var n = function (e) {
                    ...
                    function d(e, t, i) {
                        var r, a, o, u, l = t !== f, c = {};
                        for (r in e) o = e[r], r in Y ? (c.transform || (c.transform = {}), c.transform[r] = o) : (E.test(r) && (r = r.replace(/[A-Z]/g, function (e) {
                    ...
                    t.init = function (t) {
                        ...
                        e = a(e, 0), this.active ? this.queue.push({options: e}) : (this.timer = new j({
                            duration: e,
                            context: this,
                            complete: r
                        }), this.active = !0)
                    ...
                    e.init = function (e, t, n, i) {
                        ...
                        var r, o, u, l = t[0];
                        n[2] && (l = n[2]), $[l] && (l = $[l]), this.name = l, this.type = n[1], this.duration = a(t[1], this.duration, 500), this.ease = (r = t[2], o = this.ease, u = "ease", void 0 !== o && (u = o), r in d ? r : u), this.delay = a(t[3], this.delay, 0), this.span = this.duration + this.delay, this.active = !1, this.nextStyle = null, this.auto = O.test(this.name), this.unit = i.unit || this.unit || X.defaultUnit, this.angle = i.angle || this.angle || X.defaultAngle, X.fallback || i.fallback ? this.animate = this.fallback : (this.animate = this.transition, this.string = this.name + " " + this.duration + "ms" + ("ease" != this.ease ? " " + d[this.ease][0] : "") + (this.delay ? " " + this.delay + "ms" : ""))
                    }, e.set = function (e) {
                    ...
                    function a() {
                        ...
                        if (i) for (F(a), t = P(), e = i; e--;) (n = l[e]) && n.render(t)
                    }
                    ...
                    t.init = function (e) {
                        ...
                        this.active || (this.start || (this.start = P()), this.active = !0, 1 === l.push(this) && F(a))
                    }, t.stop = function () {
                        var t, n;
            ...
            var W = e.style, z = e.css, $ = {transform: R.transform && R.transform.css}, H = {
                color: [x, y],
            ...
            R.transform && (H.transform = [G], Y = {
                ...
                skewX: [b],
                skewY: [b]
            }), R.transform && R.backface && (Y.z = [I, "translateZ"], Y.rotateZ = [b], Y.scaleZ = [m], Y.perspective = [v]);
            var q = /ms/, Q = /s|\./;
            return e.tram = t
        }(window.jQuery)
    }, 5756: function (e, t, n) {
        "use strict";
        var i, r, a, o, u, l, c, s, d, f, p, g, h, E, m, y, v, I, b, _, T = window.$, O = n(5487) && T.tram;
        (i = {}).VERSION = "1.6.0-Webflow", r = {}, a = Array.prototype, o = Object.prototype, u = Function.prototype, a.push, l = a.slice, a.concat, o.toString, c = o.hasOwnProperty, s = a.forEach, d = a.map, a.reduce, a.reduceRight, f = a.filter, a.every, p = a.some, g = a.indexOf, a.lastIndexOf, h = Object.keys, u.bind, E = i.each = i.forEach = function (e, t, n) {
            if (null == e) return e;
            if (s && e.forEach === s) e.forEach(t, n); else if (e.length === +e.length) {
                for (var a = 0, o = e.length; a < o; a++) if (t.call(n, e[a], a, e) === r) return
            } else for (var u = i.keys(e), a = 0, o = u.length; a < o; a++) if (t.call(n, e[u[a]], u[a], e) === r) return;
            return e
            ...
            !t && n && (t = n);
            var r,
                a = RegExp([((t = i.defaults({}, t, i.templateSettings)).escape || y).source, (t.interpolate || y).source, (t.evaluate || y).source].join("|") + "|$", "g"),
                o = 0, u = "__p+='";
        ...
        i.define("brand", e.exports = function (e) {
            var t, n = {}, r = document, a = e("html"), o = e("body"), u = window.location,
            ...
            function d() {
                var e = o.children(".w-webflow-badge"), n = e.length && e.get(0) === t, r = i.env("editor");
                if (n) {
                    r && e.remove();
                    return
                }
        ...
        i.define("edit", e.exports = function (e, t, n) {
            ...
            var r, a = e(window), o = e(document.documentElement), u = document.location, l = "hashchange",
                c = n.load || function () {
                    var t, n, i;
                    r = !0, window.WebflowEditor = !0, a.off(l, d), t = function (t) {
                        ...
                        e.ajax({
                            ...
                            success: (n = t, function (t) {
                                ...
                                }, e.ajax({type: "GET", url: r, dataType: "script", cache: !0}).then(a, f)
                            })
                        })
        ...
        "use strict";
        var t = window.jQuery, n = {}, i = [], r = ".w-ix", a = {
            reset: function (e, t) {
                t.__wf_intro = null
            }, intro: function (e, i) {
        ...
        "use strict";
        var i = n(3949), r = n(7199);
        i.define("ix", e.exports = function (e, t) {
            var n, a, o = {}, u = e(window), l = ".w-ix", c = e.tram, s = i.env, d = s(), f = s.chrome && s.chrome < 35,
                p = "none 0s ease 0s", g = e(), h = {}, E = [], m = [], y = [], v = 1,
            ...
            function _() {
                var t;
                (t = e("[data-ix]")).length && (t.each(w), t.each(T), E.length && (i.scroll.on(A), setTimeout(A, 1)), m.length && i.load(S), y.length && setTimeout(C, v)), r.init(), i.redraw.up()
            }

            function T(n, a) {
                var u = e(a), c = h[u.attr("data-ix")];
                if (c) {
                    var s = c.triggers;
                    s && (o.style(u, c.style), t.each(s, function (e) {
                        var t = {}, n = e.type, a = e.stepsB && e.stepsB.length;
                        ...
                        if ("load" === n) return void (e.preload && !d ? m.push(o) : y.push(o));
                        if ("click" === n) {
                            u.on("click" + l, function (n) {
                                i.validClick(n.currentTarget) && ("#" === u.attr("href") && n.preventDefault(), R(e, u, {group: t.clicked ? "B" : "A"}), a && (t.clicked = !t.clicked))
                            }), g = g.add(u);
                            return
                        }
                        if ("hover" === n) {
                            u.on("mouseenter" + l, o), u.on("mouseleave" + l, c), g = g.add(u);
                            return
                        }
                        if ("scroll" === n) return void E.push({
                            el: u,
                            trigger: e,
                            state: {active: !1},
                        ...
                        if (s) {
                            var f = u.closest(s);
                            f.on(r.types.INTRO, o).on(r.types.OUTRO, c), g = g.add(f);
                            return
                        }
                    }))
                }
            ...
            function A() {
                for (var e = u.scrollTop(), t = u.height(), n = E.length, i = 0; i < n; i++) {
                    var r = E[i], a = r.el, o = r.trigger, l = o.stepsB && o.stepsB.length, c = r.state,
                        s = a.offset().top, d = a.outerHeight(), f = r.offsetTop, p = r.offsetBot;
                    f < 1 && f > 0 && (f *= t), p < 1 && p > 0 && (p *= t);
                    var g = s + d - f >= e && s + p <= e + t;
                    g !== c.active && (!1 !== g || l) && (c.active = g, R(o, a, {group: g ? "A" : "B"}))
                }
            }
            ...
            function R(t, r, a, o) {
                var u = (a = a || {}).done, l = t.preserve3d;
                if (!n || a.force) {
                    var s = a.group || "A", p = t["loop" + s], g = t["steps" + s];
                    if (g && g.length) {
                        if (g.length < 2 && (p = !1), !o) {
                            var h = t.selector;
                            h && (r = t.descend ? r.find(h) : t.siblings ? r.siblings(h) : e(h), d && r.attr("data-ix-affect", 1)), f && r.addClass("w-ix-emptyfix"), l && r.css("transform-style", "preserve-3d")
                        }
                        for (var E = c(r), m = {omit3d: !l}, y = 0; y < g.length; y++) !function (e, t, n) {
                            var r = "add", a = "start";
                            n.start && (r = a = "then");
                            var o = t.transition;
                            if (o) {
                            ...
                            if (null != c.width && (n.width = c.width), null != c.height && (n.height = c.height), null == o) {
                                n.start ? e.then(function () {
                                    var t = this.queue;
                                    this.set(c), c.display && (e.redraw(), i.redraw.up()), this.queue = t, this.next()
                                }) : (e.set(c), c.display && (e.redraw(), i.redraw.up()));
                                var s = c.wait;
                                ...
                                if (c.display) {
                                    ...
                                    delete c.display, n.start ? e.then(function () {
                                        var e = this.queue;
                                        this.set({display: d}).redraw(), i.redraw.up(), this.queue = e, this.next()
                                    }) : (e.set({display: d}).redraw(), i.redraw.up())
                                }
                                e[a](c), n.start = !0
                            }
                        }(E, g[y], m);
                ...
                function v() {
                    ...
                    "auto" === m.width && E.set({width: "auto"}), "auto" === m.height && E.set({height: "auto"}), u && u()
                }
            }

            function N(e, t) {
                var n = t && t.omit3d, i = {}, r = !1;
            ...
            return o.init = function (e) {
                ...
                a = !0, g.each(w), i.scroll.off(A), r.async(), E = [], m = [], y = []
            }, o.ready = function () {
                if (d) return s("design") ? o.design() : o.preview();
                h && a && (a = !1, _())
            }, o.run = R, o.style = d ? function (t, n) {
                var i = c(t);
                if (!e.isEmptyObject(n)) {
                    t.css("transition", "");
                    var r = t.css("transition");
                    r === p && (r = i.upstream = null), i.upstream = p, i.set(N(n)), i.upstream = r
                }
            } : function (e, t) {
                c(e).set(N(t))
            }, o
        ...
        "use strict";
        var i = n(3949), r = n(6011);
        r.setEnv(i.env), i.define("ix2", e.exports = function () {
            return r
        })
    }, 3949: function (e, t, n) {
        "use strict";
        var i, r, a = {}, o = {}, u = [], l = window.Webflow || [], c = window.jQuery, s = c(window), d = c(document),
            f = c.isFunction, p = a._ = n(5756), g = a.tram = n(5487) && c.tram, h = !1, E = !1;
        ...
        a.env.safari = /safari/.test(v) && !b && !_, I && d.on("touchstart mousedown", function (e) {
            i = e.target
        ...
        var T = "resize.webflow orientationchange.webflow load.webflow", O = "scroll.webflow " + T;
        ...
        a.resize = w(s, T), a.scroll = w(s, O), a.redraw = w(), a.location = function (e) {
            ...
            h = !0, E ? (E = !1, p.each(o, m)) : p.each(u, A), p.each(l, A), a.resize.up()
        }, a.load = function (e) {
            r.then(e)
        }, a.destroy = function (e) {
            e = e || {}, E = !0, s.triggerHandler("__wf_destroy"), null != e.domready && (h = e.domready), p.each(o, y), a.resize.off(), a.scroll.off(), a.redraw.off(), u = [], l = [], "pending" === r.state() && S()
        }, c(a.ready), S(), e.exports = window.Webflow = a
    }, 7624: function (e, t, n) {
        "use strict";
        var i = n(3949);
        i.define("links", e.exports = function (e, t) {
            var n, r, a, o = {}, u = e(window), l = i.env(), c = window.location, s = document.createElement("a"),
                d = "w--current", f = /index\.(html|php)$/, p = /\/$/;

            function g() {
                var e = u.scrollTop(), n = u.height();
                t.each(r, function (t) {
                    if (!t.link.attr("hreflang")) {
                        var i = t.link, r = t.sec, a = r.offset().top, o = r.outerHeight(), u = .5 * n,
                ...
                for (var t = document.links, o = 0; o < t.length; ++o) !function (t) {
                    if (!t.getAttribute("hreflang")) {
                        ...
                        if (s.href = i, !(i.indexOf(":") >= 0)) {
                            ...
                            "#" !== i && "" !== i && h(o, d, s.href === c.href || i === a || f.test(i) && p.test(a))
                        }
                    }
                }(t[o]);
        ...
        i.define("scroll", e.exports = function (e) {
            var t = {WF_CLICK_EMPTY: "click.wf-empty-link", WF_CLICK_SCROLL: "click.wf-scroll"}, n = window.location,
                ...
                }() ? window.history : null, a = e(window), o = e(document), u = e(document.body),
                ...
                s = "header, " + c + " > .header, " + c + " > .w-nav:not([data-no-scroll])", d = 'a[href="#"]',
                f = 'a[href*="#"]:not(.w-tab-link):not(' + d + ")", p = document.createElement("style");
            ...
            function m(t) {
                ...
                if (!(i.env("design") || window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(o.className))) {
                    ...
                    if ("" !== c) {
                        var d, f = e(c);
                        f.length && (t && (t.preventDefault(), t.stopPropagation()), d = c, n.hash !== d && r && r.pushState && !(i.env.chrome && "file:" === n.protocol) && (r.state && r.state.hash) !== d && r.pushState({hash: d}, "", d), window.setTimeout(function () {
                            !function (t, n) {
                                var i = a.scrollTop(), r = function (t) {
                                    var n = e(s), i = "fixed" === n.css("position") ? n.outerHeight() : 0,
                                        r = t.offset().top - i;
                                    if ("mid" === t.data("scroll")) {
                                        var o = a.height() - i, u = t.outerHeight();
            ...
            function i(t) {
                ...
                function c(t) {
                    if (a) {
                        ...
                        var i, l, c, s, f = t.touches, p = f ? f[0].clientX : t.clientX, g = p - r;
                        r = p, Math.abs(g) > u && n && "" === String(n()) && (i = "swipe", l = t, c = {direction: g > 0 ? "right" : "left"}, s = e.Event(i, {originalEvent: l}), e(l.target).trigger(s, c), d())
                    }
                }
        ...
        function n(e, t, n, i, r, a, o, u, l, c, s, d, f) {
            return function (p) {
                ...
                m && (h.localeId = m), r(p);
                var y = a(g, h.fields);
                return y ? o(y) : (h.fileUploads = u(g), l(p), c) ? void d.ajax({
                    url: f,
                    type: "POST",
                    data: h,
                    dataType: "json",
        ...
        i.define("forms", e.exports = function (e, t) {
            ...
            var u, l, c, s, d, f = {}, p = e(document), g = window.location, h = window.XDomainRequest && !window.atob,
                E = ".w-form", m = /e(-)?mail/i, y = /^\S+@\S+$/, v = window.alert, I = i.env();
            let b = p.find("[data-turnstile-sitekey]").data("turnstile-sitekey");
            var _ = /list-manage[1-9]?.com/i, T = t.debounce(function () {
                v("Oops! This page has improperly configured forms. Please contact your website administrator to fix this issue.")
            }, 100);

            function O(t, a) {
                var u = e(a), c = e.data(a, E);
                c || (c = e.data(a, E, {form: u})), w(c);
                ...
                c.done = f.find("> .w-form-done"), c.fail = f.find("> .w-form-fail"), c.fileUploads = f.find(".w-file-upload"), c.fileUploads.each(function (t) {
                    !function (t, n) {
                        if (n.fileUploads && n.fileUploads[t]) {
                            var i, r = e(n.fileUploads[t]), a = r.find("> .w-file-upload-default"),
                                o = r.find("> .w-file-upload-uploading"), u = r.find("> .w-file-upload-success"),
                                l = r.find("> .w-file-upload-error"), c = a.find(".w-file-upload-input"),
                                s = a.find(".w-file-upload-label"), f = s.children(),
                                p = l.find(".w-file-upload-error-msg"), g = u.find(".w-file-upload-file"),
                                h = u.find(".w-file-remove-link"), E = g.find(".w-file-upload-file-name"),
                            ...
                            if (I || s.on("click keydown", function (e) {
                            ...
                            }), s.find(".w-icon-file-upload-icon").attr("aria-hidden", "true"), h.find(".w-icon-file-upload-remove").attr("aria-hidden", "true"), I) c.on("click", function (e) {
                                e.preventDefault()
                                ...
                                h.on("click keydown", function (e) {
                                    ...
                                    c.removeAttr("data-value"), c.val(""), E.html(""), a.toggle(!0), u.toggle(!1), s.focus()
                                }), c.on("change", function (r) {
                                    var u, c, s;
                                    (i = r.target && r.target.files && r.target.files[0]) && (a.toggle(!1), l.toggle(!1), o.toggle(!0), o.focus(), E.text(i.name), S() || A(n), n.fileUploads[t].uploading = !0, u = i, c = T, s = new URLSearchParams({
                                        name: u.name,
                                        size: u.size
                                    }), e.ajax({type: "GET", url: `${d}?${s}`, crossDomain: !0}).done(function (e) {
                                        c(null, e)
                                    }).fail(function (e) {
                                        c(e)
                                    }))
                        ...
                        function _(e) {
                            var i = e.responseJSON && e.responseJSON.msg, r = v;
                            "string" == typeof i && 0 === i.indexOf("InvalidFileTypeError") ? r = y : "string" == typeof i && 0 === i.indexOf("MaxFileSizeError") && (r = m), p.text(r), c.removeAttr("data-value"), c.val(""), o.toggle(!1), a.toggle(!0), l.toggle(!0), l.focus(), n.fileUploads[t].uploading = !1, S() || w(n)
                        }

                        function T(t, n) {
                            if (t) return _(t);
                            var r = n.fileName, a = n.postData, o = n.fileId, u = n.s3Url;
                            c.attr("data-value", o), function (t, n, i, r, a) {
                                var o = new FormData;
                ...
                }(c), S(u, !0), p.on("undefined" != typeof turnstile ? "ready" : o, function () {
                    r(b, a, e => {
                ...
                if (c.handler = null, c.redirect = u.attr("data-redirect"), _.test(m)) {
                    c.handler = F;
                    return
                }
                if (!m) {
                    if (l) {
                        c.handler = (0, n(6524).default)(w, g, i, L, M, C, v, R, A, l, P, e, s);
                        return
                    }
                    T()
                }
            ...
            function C(t, n) {
                ...
                return n = n || {}, t.find(':input:not([type="submit"]):not([type="file"]):not([type="button"])').each(function (r, a) {
                    var o, u, l, c, s, d = e(a), f = d.attr("type"),
                        p = d.attr("data-name") || d.attr("name") || "Field " + (r + 1);
                    p = encodeURIComponent(p);
                    var g = d.val();
                    if ("checkbox" === f) g = d.is(":checked"); else if ("radio" === f) {
            ...
            function R(t) {
                ...
                return t.find(':input[type="file"]').each(function (t, i) {
                    var r = e(i), a = r.attr("data-name") || r.attr("name") || "File " + (t + 1),
                        o = r.attr("data-value");
            ...
            f.ready = f.design = f.preview = function () {
                b && ((a = document.createElement("script")).src = "https://challenges.cloudflare.com/turnstile/v0/api.js", document.head.appendChild(a), a.onload = () => {
                    p.trigger(o)
                }), s = "https://webflow.com/api/v1/form/" + (l = e("html").attr("data-wf-site")), h && s.indexOf("https://webflow.com") >= 0 && (s = s.replace("https://webflow.com", "https://formdata.webflow.com")), d = `${s}/signFile`, (u = e(E + " form")).length && u.each(O), (!I || i.env("preview")) && !c && function () {
                    c = !0, p.on("submit", E + " form", function (t) {
                        var n = e.data(this, E);
                        n.handler && (n.evt = t, n.handler(n))
                    });
                    let t = ".w-checkbox-input", n = ".w-radio-input", i = "w--redirected-checked",
                        r = "w--redirected-focus", a = "w--redirected-focus-visible",
            ...
            function F(n) {
                ...
                var u = n.action.replace("/post?", "/post-json?") + "&c=?", l = u.indexOf("u=") + 2;
        ...
        i.define("navbar", e.exports = function (e, t) {
            var n, o, u, l, c = {}, s = e.tram, d = e(window), f = e(document), p = t.debounce, g = i.env(),
                h = ".w-nav", E = "w--open", m = "w--nav-dropdown-open", y = "w--nav-dropdown-toggle-open",
                v = "w--nav-dropdown-list-open", I = "w--nav-link-open", b = r.triggers, _ = e();
            ...
            function w(n, i) {
                var r, o, c, s, p, g = e(i), E = e.data(i, h);
                E || (E = e.data(i, h, {
                    open: !1,
                    el: g,
                    config: {},
                    selectedIdx: -1
                })), E.menu = g.find(".w-nav-menu"), E.links = E.menu.find(".w-nav-link"), E.dropdowns = E.menu.find(".w-dropdown"), E.dropdownToggle = E.menu.find(".w-dropdown-toggle"), E.dropdownList = E.menu.find(".w-dropdown-list"), E.button = g.find(".w-nav-button"), E.container = g.find(".w-container"), E.overlayContainerId = "w-nav-overlay-" + n, E.outside = ((r = E).outside && f.off("click" + h, r.outside), function (t) {
                    var n = e(t.target);
                    l && n.closest(".w-editor-bem-EditorOverlay").length || P(r, n)
                });
                var m = g.find(".w-nav-brand");
                m && "/" === m.attr("href") && null == m.attr("aria-label") && m.attr("aria-label", "home"), E.button.attr("style", "-webkit-user-select: text;"), null == E.button.attr("aria-label") && E.button.attr("aria-label", "menu"), E.button.attr("role", "button"), E.button.attr("tabindex", "0"), E.button.attr("aria-controls", E.overlayContainerId), E.button.attr("aria-haspopup", "menu"), E.button.attr("aria-expanded", "false"), E.el.off(h), E.button.off(h), E.menu.off(h), C(E), u ? (S(E), E.el.on("setting" + h, (o = E, function (e, n) {
                    n = n || {};
                    var i = d.width();
                    C(o), !0 === n.open && U(o, !0), !1 === n.open && V(o, !0), o.open && t.defer(function () {
                        i !== d.width() && N(o)
                    })
                }))) : ((c = E).overlay || (c.overlay = e('<div class="w-nav-overlay" data-wf-ignore />').appendTo(c.el), c.overlay.attr("id", c.overlayContainerId), c.parent = c.menu.parent(), V(c, !0)), E.button.on("click" + h, L(E)), E.menu.on("click" + h, "a", F(E)), E.button.on("keydown" + h, (s = E, function (e) {
                    switch (e.keyCode) {
                        case a.SPACE:
                        case a.ENTER:
                        ...
                        case a.END:
                            ...
                            return e.keyCode === a.END ? s.selectedIdx = s.links.length - 1 : s.selectedIdx = 0, R(s), e.preventDefault(), e.stopPropagation()
                    }
                })), E.el.on("keydown" + h, (p = E, function (e) {
            ...
            function C(e) {
                var n = {}, i = e.config || {}, r = n.animation = e.el.attr("data-animation") || "default";
            ...
            c.ready = c.design = c.preview = function () {
                u = g && i.env("design"), l = i.env("editor"), n = e(document.body), (o = f.find(h)).length && (o.each(w), T(), i.resize.on(O))
            }, c.destroy = function () {
            ...
            function M(t, n) {
                var i = e.data(n, h), r = i.collapsed = "none" !== i.button.css("display");
            ...
            function U(e, t) {
                if (!e.open) {
                    e.open = !0, e.menu.each(k), e.links.addClass(I), e.dropdowns.addClass(m), e.dropdownToggle.addClass(y), e.dropdownList.addClass(v), e.button.addClass(E);
                    var n = e.config;
                    ("none" === n.animation || !s.support.transform || n.duration <= 0) && (t = !0);
                    var r = G(e), a = e.menu.outerHeight(!0), o = e.menu.outerWidth(!0), l = e.el.height(), c = e.el[0];
                    if (M(0, c), b.intro(0, c), i.redraw.up(), u || f.on("click" + h, e.outside), t) return void p();
                    var d = "transform " + n.duration + "ms " + n.easing;
                    if (e.overlay && (_ = e.menu.prev(), e.overlay.show().append(e.menu)), n.animOver) {
                        s(e.menu).add(d).set({
                            x: n.animDirect * o,
                            height: r
                        }).start({x: 0}).then(p), e.overlay && e.overlay.width(o);
                        return
                    }
                    s(e.menu).add(d).set({y: -(l + a)}).start({y: 0}).then(p)
                }
            ...
            function V(e, t) {
                if (e.open) {
                    ...
                    var n = e.config;
                    if (("none" === n.animation || !s.support.transform || n.duration <= 0) && (t = !0), b.outro(0, e.el[0]), f.off("click" + h, e.outside), t) {
                        s(e.menu).stop(), u();
                        return
                    }
                    var i = "transform " + n.duration + "ms " + n.easing2, r = e.menu.outerHeight(!0),
                        a = e.menu.outerWidth(!0), o = e.el.height();
                    if (n.animOver) return void s(e.menu).add(i).start({x: a * n.animDirect}).then(u);
                    s(e.menu).add(i).start({y: -(o + r)}).then(u)
                }
                ...
                function u() {
                    e.menu.height(""), s(e.menu).set({
                        x: 0,
                        y: 0
                    }), e.menu.each(x), e.links.removeClass(I), e.dropdowns.removeClass(m), e.dropdownToggle.removeClass(y), e.dropdownList.removeClass(v), e.overlay && e.overlay.children().length && (_.length ? e.menu.insertAfter(_) : e.menu.prependTo(e.parent), e.overlay.attr("style", "").hide()), e.el.triggerHandler("w-close"), e.button.attr("aria-expanded", "false")
                }
            }
        ...
        let a = n(7087), o = n(9468), {
            ...
            } = a.IX2EngineActionTypes, {reifyState: S} = o.IX2VanillaUtils, C = e => ({type: u, payload: {...S(e)}}),
            R = ({hasBoundaryNodes: e, reducedMotion: t}) => ({
                type: l,
                payload: {hasBoundaryNodes: e, reducedMotion: t}
            }), N = () => ({type: c}), L = () => ({type: s}),
            F = ({rawData: e, defer: t}) => ({type: d, payload: {defer: t, rawData: e}}), P = ({
            ...
            }), M = e => ({type: p, payload: {actionListId: e}}), D = () => ({type: g}),
            ...
            V = (e, t) => ({type: v, payload: {key: e, value: t}}), j = e => ({type: I, payload: {...e}}),
            B = (e, t) => ({type: b, payload: {instanceId: e, time: t}}),
            X = e => ({type: _, payload: {instanceId: e}}),
            W = (e, t, n, i) => ({type: T, payload: {elementId: e, actionTypeId: t, current: n, actionItem: i}}),
            z = ({actionListId: e, isPlaying: t}) => ({type: O, payload: {actionListId: e, isPlaying: t}}),
            $ = ({width: e, mediaQueries: t}) => ({type: w, payload: {width: e, mediaQueries: t}}),
            H = () => ({type: A})
    }, 6011: function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0});
        ...
        let o = n(9516), u = (i = n(7243)) && i.__esModule ? i : {default: i}, l = n(1970), c = function (e, t) {
        ...
        for (var r in i) Object.defineProperty(t, r, {enumerable: !0, get: i[r]});
        let a = n(9468), o = n(7087), {ELEMENT_MATCHES: u} = a.IX2BrowserSupport, {
            IX2_ID_DELIMITER: l,
            HTML_ELEMENT: c,
            PLAIN_OBJECT: s,
            WF_PAGE: d
        ...
        for (var r in i) Object.defineProperty(t, r, {enumerable: !0, get: i[r]});
        let a = y(n(9777)), o = y(n(4738)), u = y(n(4659)), l = y(n(3452)), c = y(n(6633)), s = y(n(3729)),
            d = y(n(2397)), f = y(n(5082)), p = n(7087), g = n(9468), h = n(3946), E = function (e, t) {
                if (e && e.__esModule) return e;
                if (null === e || "object" != typeof e && "function" != typeof e) return {default: e};
                var n = v(t);
                if (n && n.has(e)) return n.get(e);
        ...
        let I = Object.keys(p.QuickEffectIds), b = e => I.includes(e), {
                COLON_DELIMITER: _,
                BOUNDARY_SELECTOR: T,
                HTML_ELEMENT: O,
                RENDER_GENERAL: w,
                ...
                mediaQueriesEqual: W,
                shallowEqual: z
            } = g.IX2VanillaUtils, {isPluginType: $, createPluginInstance: H, getPluginDuration: Y} = g.IX2VanillaPlugins,
            q = navigator.userAgent, Q = q.match(/iPad/i) || q.match(/iPhone/);

        function K(e) {
            N({store: e, select: ({ixRequest: e}) => e.preview, onChange: Z}), N({
                store: e,
                select: ({ixRequest: e}) => e.playback,
                onChange: ee
            }), N({store: e, select: ({ixRequest: e}) => e.stop, onChange: et}), N({
                store: e,
        ...
        function ee(e, t) {
            ...
            if (ei({
                ...
                ep({store: t, actionListId: i}), ed({store: t, actionListId: i, eventId: a});
                let e = eg({store: t, eventId: a, actionListId: i, immediate: u, verbose: c});
                c && e && t.dispatch((0, h.actionListPlaybackChanged)({actionListId: i, isPlaying: !u}))
            }
        }
        ...
        function ei({store: e, rawData: t, allowEvents: n, testManual: i}) {
            ...
            if (t && e.dispatch((0, h.rawDataImported)(t)), !r.active) {
                (e.dispatch((0, h.sessionInitialized)({
                    ...
                    eu(e), (0, d.default)(n, (t, n) => {
                        ...
                        !function ({logic: e, store: t, events: n}) {
                            !function (e) {
                                ...
                                let t = {}, n = "";
                                for (let i in e) {
                                    let {eventTypeId: r, target: a} = e[i], o = E.getQuerySelector(a);
                            ...
                            let {types: i, handler: r} = e, {ixData: l} = t.getState(), {actionLists: c} = l,
                                s = el(n, es);
                            ...
                            (0, d.default)(s, (e, i) => {
                                ...
                                } = r, {actionListId: f} = u.config;
                                W(d, l.mediaQueryKeys) || t.dispatch((0, h.mediaQueriesDefined)()), u.actionTypeId === p.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION && (Array.isArray(r.config) ? r.config : [r.config]).forEach(n => {
                                    let {continuousParameterGroupId: i} = n,
                                        r = (0, o.default)(c, `${f}.continuousParameterGroups`, []),
                                        u = (0, a.default)(r, ({id: e}) => e === i), l = (n.smoothing || 0) / 100,
                                    ...
                                    u && e.forEach((e, i) => {
                                        !function ({
                                            ...
                                            let {ixData: s, ixSession: d} = e.getState(), {events: f} = s,
                                                g = f[i], {eventTypeId: h} = g, m = {}, y = {},
                                                v = [], {continuousActionGroups: I} = u, {id: b} = u;
                                            U(h, r) && (b = G(t, b));
                                            let O = d.hasBoundaryNodes && n ? E.getClosestElement(n, T) : null;
                                            I.forEach(e => {
                                                let {keyframe: t, actionItems: i} = e;
                                                i.forEach(e => {
                                                    let {actionTypeId: i} = e, {target: r} = e.config;
                                                    if (!r) return;
                                                    let a = r.boundaryMode ? O : null, o = X(r) + _ + i;
                                                ...
                                                let r = y[n],
                                                    u = (0, o.default)(r, "[0].actionItems[0]", {}), {actionTypeId: s} = u,
                                                    d = (s === p.ActionTypeConsts.PLUGIN_RIVE ? 0 === (u.config?.target?.selectorGuids || []).length : $(s)) ? H(s)?.(t, u) : null,
                                                    f = R({element: t, actionItem: u, elementApi: E}, d);
                                                eh({
                                                    store: e,
                                                    element: t,
                                                    eventId: i,
                            ...
                            }, m = (0, f.default)(g, 12), y = ({target: e = document, types: n, throttle: i}) => {
                    ...
                    onChange: () => {
                        er(e), P({store: e, elementApi: E}), ei({store: e, allowEvents: !0}), J()
                    }
                }));
                e.dispatch((0, h.sessionStarted)()), function (e, t) {
                    let n = i => {
                        let {ixSession: r, ixParameters: a} = e.getState();
                        if (r.active) if (e.dispatch((0, h.animationFrameChanged)(i, a)), t) {
                            let t = N({
        ...
        function eu(e) {
            ...
            if (i !== t.viewportWidth) {
                ...
                e.dispatch((0, h.viewportWidthChanged)({width: i, mediaQueries: t}))
            }
        }
        ...
        }, es = e => S({config: {target: e.target, targets: e.targets}, elementApi: E});

        function ed({store: e, actionListId: t, eventId: n}) {
            let {ixData: i, ixSession: r} = e.getState(), {actionLists: a, events: u} = i, l = u[n], c = a[t];
            if (c && c.useFirstGroupAsInitialState) {
                ...
                a.forEach(i => {
                    let {config: r, actionTypeId: a} = i, o = S({
                        config: r?.target?.useEventTarget === !0 && r?.target?.objectId == null ? {
                            target: l.target,
                            targets: l.targets
                        } : r, event: l, elementApi: E
                    }), u = $(a);
                    o.forEach(r => {
                        let o = u ? H(a)?.(r, i) : null;
                        eh({
                            destination: R({element: r, actionItem: i, elementApi: E}, o),
                            immediate: !0,
                            store: e,
                            element: r,
                            eventId: n,
        ...
        function ef({store: e}) {
            ...
            (0, d.default)(t, t => {
                if (!t.continuous) {
                    ...
                    eE(t, e), i && e.dispatch((0, h.actionListPlaybackChanged)({actionListId: n, isPlaying: !1}))
                }
            })
        }
        ...
        function ep({store: e, eventId: t, eventTarget: n, eventStateKey: i, actionListId: r}) {
            let {ixInstances: a, ixSession: u} = e.getState(),
                l = u.hasBoundaryNodes && n ? E.getClosestElement(n, T) : null;
            (0, d.default)(a, n => {
                let a = (0, o.default)(n, "actionItem.config.target.boundaryMode"), u = !i || n.eventStateKey === i;
                if (n.actionListId === r && n.eventId === t && u) {
                    if (l && a && !E.elementContains(l, n.element)) return;
        ...
        function eg({
            ...
            let {ixData: c, ixSession: s} = e.getState(), {events: d} = c,
                f = d[t] || {}, {mediaQueries: p = c.mediaQueryKeys} = f, {
                    actionItemGroups: g,
                    useFirstGroupAsInitialState: h
                } = (0, o.default)(c, `actionLists.${r}`, {});
            if (!g || !g.length) return !1;
            a >= g.length && (0, o.default)(f, "config.loop") && (a = 0), 0 === a && h && a++;
            let m = (0 === a || 1 === a && h) && b(f.action?.actionTypeId) ? f.config.delay : void 0,
                y = (0, o.default)(g, [a, "actionItems"], []);
            if (!y.length || !V(p, s.mediaQueryKey)) return !1;
            let v = s.hasBoundaryNodes && n ? E.getClosestElement(n, T) : null, I = M(y), _ = !1;
            return y.forEach((o, c) => {
                let {config: s, actionTypeId: d} = o, p = $(d), {target: g} = s;
                g && S({
                    config: s,
                    event: f,
                    eventTarget: n,
                    ...
                    let g = p ? H(d)?.(s, o) : null, h = p ? Y(d)(s, o) : null;
                    _ = !0;
                    let y = D({element: s, actionItem: o}), v = R({element: s, actionItem: o, elementApi: E}, g);
                    eh({
                        store: e,
                        element: s,
                        actionItem: o,
        ...
        function eh(e) {
            let t, {store: n, computedStyle: i, ...r} = e, {
                    element: a,
                    actionItem: o,
                    immediate: u,
                    pluginInstance: l,
                    ...
                    restingValue: s,
                    eventId: d
                } = r, f = L(), {ixElements: g, ixSession: m, ixData: y} = n.getState(),
                v = C(g, a), {refState: I} = g[v] || {}, b = E.getRefType(a),
                _ = m.reducedMotion && p.ReducedMotionTypes[o.actionTypeId];
            if (_ && c) switch (y.events[d]?.eventTypeId) {
            ...
            if (n.dispatch((0, h.instanceAdded)({
                ...
                skipMotion: _,
                skipToValue: t, ...r
            })), em(document.body, "ix2-animation-started", f), u) return void function (e, t) {
            ...
            N({
                ...
                onChange: ey
            }), c || n.dispatch((0, h.instanceStarted)(f, m.tick))
        }

        function eE(e, t) {
            em(document.body, "ix2-animation-stopping", {instanceId: e.id, state: t.getState()});
            let {elementId: n, actionItem: i} = e, {ixElements: r} = t.getState(), {ref: a, refType: o} = r[n] || {};
            o === O && j(a, i, E), t.dispatch((0, h.instanceRemoved)(e.id))
        }
        ...
        function ey(e, t) {
            let {
                ...
                ixData: b,
                ixSession: _
            } = t.getState(), {events: T} = b, {mediaQueries: A = b.mediaQueryKeys} = T && T[d] ? T[d] : {};
            if (V(A, _.mediaQueryKey) && (i || n || r)) {
                if (c || l === w && r) {
                    t.dispatch((0, h.elementStateChanged)(a, u, c, o));
                    let {ixElements: e} = t.getState(), {ref: n, refType: i, refState: r} = e[a] || {}, s = r && r[u];
                    (i === O || $(u)) && F(n, r, s, d, o, y, E, l, I)
                }
                if (r) {
                    if (m) {
                        let e = eg({
                        ...
                        v && !e && t.dispatch((0, h.actionListPlaybackChanged)({actionListId: g, isPlaying: !1}))
                    }
                    eE(e, t)
                }
            }
        ...
        let r = d(n(5801)), a = d(n(4738)), o = d(n(3789)), u = n(7087), l = n(1970), c = n(3946), s = n(9468);
        ...
        let {
                ...
                PAGE_START: D,
                PAGE_SCROLL: k
            } = u.EventTypeConsts, x = "COMPONENT_ACTIVE",
            U = "COMPONENT_INACTIVE", {COLON_DELIMITER: G} = u.IX2EngineConstants, {getNamespacedParameterId: V} = s.IX2VanillaUtils,
            j = e => t => !!("object" == typeof t && e(t)) || t,
            B = j(({element: e, nativeEvent: t}) => e === t.target),
            X = j(({element: e, nativeEvent: t}) => e.contains(t.target)), W = (0, r.default)([B, X]), z = (e, t) => {
                if (t) {
                    let {ixData: n} = e.getState(), {events: i} = n, r = i[t];
                ...
                let {action: o, id: u} = t, {actionListId: c, autoStopEventId: s} = o.config, d = z(e, s);
                return d && (0, l.stopActionGroup)({
                    ...
                    eventStateKey: i,
                    actionListId: c
                }), (0, l.startActionGroup)({store: e, eventId: u, eventTarget: n, eventStateKey: i, actionListId: c}), r
            }, Y = (e, t) => (n, i) => !0 === e(n, i) ? t(n, i) : i, q = {handler: Y(W, H)},
            Q = {...q, types: [x, U].join(" ")},
            K = [{target: window, types: "resize orientationchange", throttle: !0}, {
                target: document,
                types: "scroll wheel readystatechange IX2_PAGE_UPDATE",
                throttle: !0
            }], Z = "mouseover mouseout", J = {types: K}, ee = {PAGE_START: D, PAGE_FINISH: F}, et = (() => {
            ...
            ei = ({element: e, nativeEvent: t}) => {
                let {type: n, target: i, relatedTarget: r} = t, a = e.contains(i);
                if ("mouseover" === n && a) return !0;
                let o = e.contains(r);
                return "mouseout" === n && !!a && !!o
            }, er = e => {
                let {element: t, event: {config: n}} = e, {clientWidth: i, clientHeight: r} = et(), a = n.scrollOffsetValue,
                    o = "PX" === n.scrollOffsetUnit ? a : r * (a || 0) / 100;
                return en(t.getBoundingClientRect(), {left: 0, top: o, right: i, bottom: r - o})
            }, ea = e => (t, n) => {
                let {type: i} = t.nativeEvent, r = -1 !== [x, U].indexOf(i) ? i === x : n.isActive, a = {...n, isActive: r};
                ...
                let i, r, {stiffScrollTop: a, scrollHeight: o, innerHeight: u} = et(), {
                    event: {
                        config: l,
                        eventTypeId: c
                    }
                } = t, {scrollOffsetValue: s, scrollOffsetUnit: d} = l, f = o - u, p = Number((a / f).toFixed(2));
                if (n && n.percentTop === p) return n;
                let g = ("PX" === d ? s : u * (s || 0) / 100) / f, h = 0;
                n && (i = p > n.percentTop, h = (r = n.scrollingDown !== i) ? p : n.anchorTop);
                let E = c === S ? p >= h + g : p <= h - g,
                    m = {...n, percentTop: p, inBounds: E, anchorTop: h, scrollingDown: i};
                return n && E && (r || m.inBounds !== n.inBounds) && e(t, m) || m
            }, el = (e, t) => e.left > t.left && e.left < t.right && e.top > t.top && e.top < t.bottom,
            ec = e => (t, n = {clickCount: 0}) => {
                let i = {clickCount: n.clickCount % 2 + 1};
                return i.clickCount !== n.clickCount && e(t, i) || i
            }, es = (e = !0) => ({...Q, handler: Y(e ? W : B, ea((e, t) => t.isActive ? q.handler(e, t) : t))}),
            ed = (e = !0) => ({...Q, handler: Y(e ? W : B, ea((e, t) => t.isActive ? t : q.handler(e, t)))}), ef = {
                ...J, handler: (i = (e, t) => {
                    let {elementVisible: n} = t, {event: i, store: r} = e, {ixData: a} = r.getState(), {events: o} = a;
                    return !o[i.action.config.autoStopEventId] && t.triggered ? t : i.eventTypeId === C === n ? (H(e), {
                        ...t,
                        triggered: !0
                    }) : t
                }, (e, t) => {
                ...
                [f]: {
                    types: "click", handler: Y(W, ec((e, {clickCount: t}) => {
                        $(e) ? 1 === t && H(e) : H(e)
                    }))
                },
                [p]: {
                ...
                [A]: {
                    ...
                    handler: ({store: e, element: t, eventConfig: n, nativeEvent: i, eventStateKey: r}, a = {
                        ...
                        let {
                                ...
                                reverse: d,
                                restingState: f = 0
                            } = n, {clientX: p = a.clientX, clientY: g = a.clientY, pageX: h = a.pageX, pageY: E = a.pageY} = i,
                            m = "X_AXIS" === l, y = "mouseout" === i.type, v = f / 100, I = s, b = !1;
                        switch (o) {
                            ...
                            case u.EventBasedOn.PAGE: {
                                ...
                                v = m ? Math.min(e + h, n) / n : Math.min(t + E, i) / i;
                                break
                            }
                            ...
                            default: {
                                ...
                                let n = t.getBoundingClientRect(), {left: a, top: o, width: u, height: l} = n;
                ...
                [L]: {
                    types: K,
                    handler: ({element: e, store: t, eventConfig: n, eventStateKey: i}, r = {scrollPercent: 0}) => {
                        let {
                            scrollLeft: a,
                            scrollTop: o,
                            scrollWidth: l,
                        ...
                        {
                            let n = V(i, g), a = e.getBoundingClientRect(), o = (y ? v : 0) / 100, u = (m ? I : 0) / 100;
                            o = h ? o : 1 - o, u = E ? u : 1 - u;
                            let l = a.top + Math.min(a.height * o, d), f = Math.min(d + (a.top + a.height * u - l), s),
                                p = Math.min(Math.max(0, d - l), f) / f;
                            return p !== r.scrollPercent && t.dispatch((0, c.parameterChanged)(n, p)), {scrollPercent: p}
                        }
                    }
                },
                [C]: ef,
                ...
                [F]: {
                    types: "readystatechange IX2_PAGE_UPDATE", handler: Y(B, (e, t) => {
                        let n = {finished: "complete" === document.readyState};
                        return n.finished && !(t && t.finshed) && H(e), n
                    })
                },
                [D]: {types: "readystatechange IX2_PAGE_UPDATE", handler: Y(B, (e, t) => (t || H(e), {started: !0}))}
            }
    }, 4609: function (e, t, n) {
        "use strict";
        ...
        let i = n(7087), r = n(9468), a = n(1185), {
        ...
        } = r.IX2EasingUtils, {RENDER_GENERAL: h} = i.IX2EngineConstants, {
            getItemConfigByKey: E,
            getRenderType: m,
            getStyleProp: y
        } = r.IX2VanillaUtils, v = (e, t) => {
            let n, i, r, o, {
                position: u,
                parameterId: l,
                actionGroups: c,
                ...
                skipMotion: y,
                skipToValue: v
            } = e, {parameters: I} = t.payload, b = Math.max(1 - d, .01), _ = I[l];
            null == _ && (b = 1, _ = g);
            let T = f((Math.max(_, 0) || 0) - u), O = y ? v : f(u + T * b), w = 100 * O;
            ...
            if (n && !i) for (let e = 0, {length: t} = s; e < t; e++) {
                ...
                let e = (O - r) / o, t = p(n.config.easing, e, m);
                for (let e = 0, {length: r} = s; e < r; e++) {
                    let r = s[e], a = E(h, r, n.config), o = (E(h, r, i.config) - a) * t + a;
                    A[r] = o
                }
            }
            ...
            let {
                ...
                customEasingFn: m,
                skipMotion: y
            } = e, v = c.config.easing, {duration: I, delay: b} = c.config;
            null != g && (I = g), b = null != E ? E : b, u === h ? I = 0 : (o || y) && (I = b = 0);
            let {now: _} = t.payload;
            if (n && i) {
                let t = _ - (r + b);
                if (l) {
                    let t = I + b, n = f(Math.min(Math.max(0, (_ - r) / t), 1));
                    e = (0, a.set)(e, "verboseTimeElapsed", t * n)
                }
                if (t < 0) return e;
                let n = f(Math.min(Math.max(0, t / I), 1)), o = p(v, n, m), u = {}, c = null;
                return d.length && (c = d.reduce((e, t) => {
                    let n = s[t], r = parseFloat(i[t]) || 0, a = parseFloat(n) - r;
                    return e[t] = a * o + r, e
            ...
            switch (t.type) {
                ...
                case l: {
                    let {
                            ...
                            skipMotion: S,
                            skipToValue: C
                        } = t.payload, {actionTypeId: R} = r, N = m(R), L = y(N, R),
                        F = Object.keys(p).filter(e => null != p[e] && "string" != typeof p[e]), {easing: P} = r.config;
                    return (0, a.set)(e, n, {
                        id: n,
                        elementId: i,
                        active: !1,
                ...
                case s: {
                    ...
                    if (!e[n]) return e;
                    let i = {}, r = Object.keys(e), {length: a} = r;
                    for (let t = 0; t < a; t++) {
                        let a = r[t];
                        a !== n && (i[a] = e[a])
                    }
                ...
                case d: {
                    let n = e, i = Object.keys(e), {length: r} = i;
                    for (let o = 0; o < r; o++) {
                        let r = i[o], u = e[r], l = u.continuous ? v : I;
                        n = (0, a.set)(n, r, l(u, t))
                    }
                    return n
                }
        ...
        let i = n(9516), r = n(4609), a = n(628), o = n(5862), u = n(9468), l = n(7718),
            c = n(1540), {ixElements: s} = u.IX2ElementsReducer, d = (0, i.combineReducers)({
                ixData: r.ixData,
        ...
        let i = n(7087), r = n(1185), {
            IX2_PREVIEW_REQUESTED: a,
            IX2_PLAYBACK_REQUESTED: o,
            IX2_STOP_REQUESTED: u,
            IX2_CLEAR_REQUESTED: l
        } = i.IX2EngineActionTypes, c = {preview: {}, playback: {}, stop: {}, clear: {}}, s = Object.create(null, {
            [a]: {value: "preview"},
            [o]: {value: "playback"},
            [u]: {value: "stop"},
            [l]: {value: "clear"}
        ...
        let i = n(7087), r = n(1185), {
            ...
            switch (t.type) {
                ...
                case p: {
                    let {width: n, mediaQueries: i} = t.payload, a = i.length, o = null;
                    for (let e = 0; e < a; e++) {
        ...
        let r = e => e.value, a = (e, t) => {
            if ("auto" !== t.config.duration) return null;
            let n = parseFloat(e.getAttribute("data-duration"));
            return n > 0 ? 1e3 * n : 1e3 * parseFloat(e.getAttribute("data-default-duration"))
        }, o = e => e || {value: 0}, u = e => ({value: e.value}), l = e => {
        ...
        for (var i in n) Object.defineProperty(t, i, {enumerable: !0, get: n[i]});
        let r = "--wf-rive-fit", a = "--wf-rive-alignment", o = e => document.querySelector(`[data-w-id="${e}"]`),
            u = () => window.Webflow.require("rive"), l = (e, t) => e.value.inputs[t], c = () => null, s = (e, t) => {
                if (e) return e;
                let n = {}, {inputs: i = {}} = t.config.value;
                for (let e in i) null == i[e] && (n[e] = 0);
                return n
            }, d = e => e.value.inputs ?? {}, f = (e, t) => {
                ...
                let i = u();
                if (!i) return;
                let o = i.getInstance(e), l = i.rive.StateMachineInputType, {
                    name: c,
                    inputs: s = {}
                } = n.config.value || {};
                    ...
                    function n() {
                        ...
                        if (null != n) {
                            if (e.isPlaying || e.play(c, !1), r in s || a in s) {
                                let t = e.layout, n = s[r] ?? t.fit, i = s[a] ?? t.alignment;
        ...
        for (var i in n) Object.defineProperty(t, i, {enumerable: !0, get: n[i]});
        let r = e => document.querySelector(`[data-w-id="${e}"]`), a = () => window.Webflow.require("spline"),
            o = (e, t) => e.filter(e => !t.includes(e)), u = (e, t) => e.value[t], l = () => null, c = Object.freeze({
                positionX: 0,
                positionY: 0,
                positionZ: 0,
                rotationX: 0,
                ...
                let i = a();
                if (!i) return;
                let r = i.getInstance(e), o = n.config.target.objectId, u = e => {
        ...
        for (var r in i) Object.defineProperty(t, r, {enumerable: !0, get: i[r]});
        let a = n(380), o = (e, t) => e.value[t], u = () => null, l = (e, t) => {
            if (e) return e;
            let n = t.config.value, i = t.config.target.objectId,
            ...
            let {target: {objectId: i}, value: {unit: r}} = n.config, a = t.PLUGIN_VARIABLE,
        ...
        let i = n(7087), r = c(n(7377)), a = c(n(2866)), o = c(n(5163)), u = c(n(1407));
        ...
        let s = new Map([[i.ActionTypeConsts.PLUGIN_LOTTIE, {...r}], [i.ActionTypeConsts.PLUGIN_SPLINE, {...a}], [i.ActionTypeConsts.PLUGIN_RIVE, {...o}], [i.ActionTypeConsts.PLUGIN_VARIABLE, {...u}]])
    }, 8023: function (e, t) {
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0});
        var n = {
        ...
        for (var i in n) Object.defineProperty(t, i, {enumerable: !0, get: n[i]});
        let r = "IX2_RAW_DATA_IMPORTED", a = "IX2_SESSION_INITIALIZED", o = "IX2_SESSION_STARTED",
            u = "IX2_SESSION_STOPPED", l = "IX2_PREVIEW_REQUESTED", c = "IX2_PLAYBACK_REQUESTED",
            s = "IX2_STOP_REQUESTED", d = "IX2_CLEAR_REQUESTED", f = "IX2_EVENT_LISTENER_ADDED",
            p = "IX2_EVENT_STATE_CHANGED", g = "IX2_ANIMATION_FRAME_CHANGED", h = "IX2_PARAMETER_CHANGED",
            E = "IX2_INSTANCE_ADDED", m = "IX2_INSTANCE_STARTED", y = "IX2_INSTANCE_REMOVED",
            v = "IX2_ELEMENT_STATE_CHANGED", I = "IX2_ACTION_LIST_PLAYBACK_CHANGED", b = "IX2_VIEWPORT_WIDTH_CHANGED",
            _ = "IX2_MEDIA_QUERIES_DEFINED", T = "IX2_TEST_FRAME_RENDERED"
    }, 2686: function (e, t) {
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0});
        var n = {
        ...
        for (var i in n) Object.defineProperty(t, i, {enumerable: !0, get: n[i]});
        let r = "|", a = "data-wf-page", o = "w-mod-js", u = "w-mod-ix", l = ".w-dyn-item", c = "xValue", s = "yValue",
            d = "zValue", f = "value", p = "xUnit", g = "yUnit", h = "zUnit", E = "unit", m = "transform",
            y = "translateX", v = "translateY", I = "translateZ", b = "translate3d", _ = "scaleX", T = "scaleY",
            O = "scaleZ", w = "scale3d", A = "rotateX", S = "rotateY", C = "rotateZ", R = "skew", N = "skewX",
            L = "skewY", F = "opacity", P = "filter", M = "font-variation-settings", D = "width", k = "height",
            x = "backgroundColor", U = "background", G = "borderColor", V = "color", j = "display", B = "flex",
            X = "willChange", W = "AUTO", z = ",", $ = ":", H = "|", Y = "CHILDREN", q = "IMMEDIATE_CHILDREN",
            Q = "SIBLINGS", K = "PARENT", Z = "preserve-3d", J = "HTML_ELEMENT", ee = "PLAIN_OBJECT",
            et = "ABSTRACT_NODE", en = "RENDER_TRANSFORM", ei = "RENDER_GENERAL", er = "RENDER_STYLE",
            ea = "RENDER_PLUGIN"
    }, 262: function (e, t) {
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0});
        ...
        for (var r in i) Object.defineProperty(t, r, {enumerable: !0, get: i[r]});
        let a = c(n(1833), t), o = c(n(262), t);
        c(n(8704), t), c(n(3213), t);
        let u = d(n(8023)), l = d(n(2686));
        ...
        } = n(262).ActionTypeConsts, s = {[i]: !0, [r]: !0, [a]: !0, [o]: !0, [u]: !0, [l]: !0, [c]: !0}
    }, 1833: function (e, t) {
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0});
        var n = {
        ...
        let r = {
            ...
            }, a = {ELEMENT: "ELEMENT", CLASS: "CLASS", PAGE: "PAGE"}, o = {ELEMENT: "ELEMENT", VIEWPORT: "VIEWPORT"},
            u = {X_AXIS: "X_AXIS", Y_AXIS: "Y_AXIS"},
            l = {CHILDREN: "CHILDREN", SIBLINGS: "SIBLINGS", IMMEDIATE_CHILDREN: "IMMEDIATE_CHILDREN"}, c = {
        ...
        function i(e) {
            let t, i, r, a = 1, o = e.replace(/\s/g, "").toLowerCase(),
            ...
            if (u.startsWith("#")) {
                ...
                let e, n, o, l = u.match(/hsla\(([^)]+)\)/)[1].split(","), c = parseFloat(l[0]),
                    s = parseFloat(l[1].replace("%", "")) / 100, d = parseFloat(l[2].replace("%", "")) / 100;
                a = parseFloat(l[3]);
                let f = (1 - Math.abs(2 * d - 1)) * s, p = f * (1 - Math.abs(c / 60 % 2 - 1)), g = d - f / 2;
                ...
                let e, n, a, o = u.match(/hsl\(([^)]+)\)/)[1].split(","), l = parseFloat(o[0]),
                    c = parseFloat(o[1].replace("%", "")) / 100, s = parseFloat(o[2].replace("%", "")) / 100,
                    d = (1 - Math.abs(2 * s - 1)) * c, f = d * (1 - Math.abs(l / 60 % 2 - 1)), p = s - d / 2;
        ...
        for (var r in i) Object.defineProperty(t, r, {enumerable: !0, get: i[r]});
        let a = f(n(2662)), o = f(n(8686)), u = f(n(3767)), l = f(n(5861)), c = f(n(1799)), s = f(n(4124));
        ...
        for (var a in r) Object.defineProperty(t, a, {enumerable: !0, get: r[a]});
        let o = (i = n(9777)) && i.__esModule ? i : {default: i}, u = "undefined" != typeof window,
            l = (e, t) => u ? e() : t,
            ...
            s = l(() => {
                ...
                return "transform"
            }, "transform"), f = d.split("transform")[0], p = f ? f + "TransformStyle" : "transformStyle"
    }, 3767: function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0});
        var i, r = {
        ...
        let o = function (e, t) {
            ...
            return i.default = e, n && n.set(e, i), i
        }(n(8686)), u = (i = n(1361)) && i.__esModule ? i : {default: i};
        ...
        function c(e, t = 5, n = 10) {
            let i = Math.pow(n, t), r = Number(Math.round(e * i) / i);
        ...
        for (var a in r) Object.defineProperty(t, a, {enumerable: !0, get: r[a]});
        let o = (i = n(1361)) && i.__esModule ? i : {default: i}, u = (0, o.default)(.25, .1, .25, 1),
            l = (0, o.default)(.42, 0, 1, 1), c = (0, o.default)(0, 0, .58, 1), s = (0, o.default)(.42, 0, .58, 1);
        ...
        let l = e => t => {
                ...
                return i
            }, c = l("getPluginConfig"), s = l("getPluginOrigin"), d = l("getPluginDuration"),
            f = l("getPluginDestination"), p = l("createPluginInstance"), g = l("renderPlugin"), h = l("clearPlugin")
    }, 4124: function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0});
        var i = {
        ...
        for (var r in i) Object.defineProperty(t, r, {enumerable: !0, get: i[r]});
        let a = h(n(4075)), o = h(n(1455)), u = h(n(5720)), l = n(1185), c = n(7087), s = h(n(7164)), d = n(3767),
            f = n(380), p = n(1799), g = n(2662);
        ...
        let {
                ...
                GENERAL_DISPLAY: ea,
                OBJECT_VALUE: eo
            } = c.ActionTypeConsts, eu = e => e.trim(), el = Object.freeze({[en]: L, [ei]: F, [er]: P}),
            ec = Object.freeze({[g.TRANSFORM_PREFIXED]: m, [L]: E, [A]: A, [S]: S, [R]: R, [N]: N, [C]: C}),
            es = new Map;
        ...
        function ey({store: e, select: t, onChange: n, comparator: i = em}) {
            let {getState: r, subscribe: a} = e, o = a(function () {
                let a = t(r());
        ...
        function eI({config: e, event: t, eventTarget: n, elementRoot: i, elementApi: r}) {
            ...
            if (!v) return [];
            let {id: I, objectId: b, selector: _, selectorGuids: T, appliesTo: O, useEventTarget: w} = ev(v);
            if (b) return [es.has(b) ? es.get(b) : es.set(b, {}).get(b)];
            if (O === c.EventAppliesTo.PAGE) {
                let e = s(I);
                return e ? [e] : []
            }
            let A = (t?.action?.config?.affectedElements ?? {})[I || _] || {}, S = !!(A.id || A.selector),
                C = t && d(ev(t.target));
            if (S ? (a = A.limitAffectedElements, o = C, u = d(A)) : o = u = d({
                id: I,
                selector: _,
                selectorGuids: T
            }), t && w) {
            ...
            return null == o || null == u ? [] : g.IS_BROWSER_ENV && i ? f(u).filter(e => i.contains(e)) : a === M ? f(o, u) : a === D ? p(f(o)).filter(E(u)) : a === k ? h(f(o)).filter(E(u)) : f(u)
        }
        ...
        let e_ = /px/, eT = (e, t) => t.reduce((e, t) => (null == e[t.type] && (e[t.type] = eM[t.type]), e), e || {}),
            eO = (e, t) => t.reduce((e, t) => (null == e[t.type] && (e[t.type] = eD[t.type] || t.defaultValue || 0), e), e || {});

        function ew(e, t = {}, n = {}, i, r) {
            let {getStyle: o} = r, {actionTypeId: u} = i;
            ...
            switch (i.actionTypeId) {
                ...
                case er:
                    return function ({element: e, actionTypeId: t, computedStyle: n, getStyle: i}) {
                        let r = el[t], o = i(e, r), u = (function (e, t) {
                            let n = e.exec(t);
                            return n ? n[1] : ""
        ...
        let eA = (e, t) => (t && (e[t.type] = t.value || 0), e), eS = (e, t) => (t && (e[t.type] = t.value || 0), e),
            eC = (e, t, n) => {
            ...
            switch (t.actionTypeId) {
                ...
                case et: {
                    let {getStyle: i, setStyle: r, getProperty: a} = n, {
                        widthUnit: o,
                        heightUnit: u
                    } = t.config, {widthValue: l, heightValue: c} = t.config;
                ...
                case er: {
                    ...
                    if (u && u.startsWith("--")) {
                        let {getStyle: t} = n, i = t(e, u), r = (0, f.normalizeColor)(i);
        ...
        function eF(e, t, n, i, r, a, u, l, c) {
            switch (l) {
                case W:
                    ...
                    eV(s, g.TRANSFORM_PREFIXED, E), A(s, g.TRANSFORM_PREFIXED, m), function ({actionTypeId: e}, {
                        xValue: t,
                        yValue: n,
                        zValue: i
                    }) {
                    ...
                    return function (e, t, n, i, r, a) {
                        ...
                        switch (i.actionTypeId) {
                            case et: {
                                ...
                                void 0 !== o && (t === V && (t = "px"), eV(e, R, a), u(e, R, o + t)), void 0 !== l && (r === V && (r = "px"), eV(e, N, a), u(e, N, l + r));
                                break
                            }
                            case J:
                                var l = i.config;
                                let c = (0, o.default)(n, (e, t, n) => `${e} ${n}(${t}${ek(n, l)})`, ""), {setStyle: s} = a;
                                eV(e, S, a), s(e, S, c);
                                break;
                            case ee:
                                i.config;
                                let d = (0, o.default)(n, (e, t, n) => (e.push(`"${n}" ${t}`), e), []).join(", "), {setStyle: f} = a;
                                eV(e, C, a), f(e, C, d);
                                break;
                            case en:
                            case ei:
                            case er: {
                                let t = el[i.actionTypeId], r = Math.round(n.rValue), o = Math.round(n.gValue),
                                    l = Math.round(n.bValue), c = n.aValue;
        ...
        let eP = {
            ...
            contrast: 100,
            brightness: 100
        }), eD = Object.freeze({wght: 0, opsz: 0, wdth: 0, slnt: 0}), ek = (e, t) => {
        ...
        }, ex = Object.keys(eP), eU = /^rgb/, eG = RegExp("rgba?\\(([^)]+)\\)");

        function eV(e, t, n) {
            if (!g.IS_BROWSER_ENV) return;
            let i = ec[t];
            if (!i) return;
            let {getStyle: r, setStyle: a} = n, o = r(e, G);
        ...
        function eB({store: e, elementApi: t}) {
            let {ixData: n} = e.getState(), {events: i = {}, actionLists: r = {}} = n;
            Object.keys(i).forEach(e => {
                let n = i[e], {config: a} = n.action, {actionListId: o} = a, u = r[o];
        ...
        function ez(e, t, n) {
            let {setStyle: i, getStyle: r} = n, {actionTypeId: a} = t;
            if (a === et) {
                let {config: n} = t;
                n.widthUnit === V && i(e, R, ""), n.heightUnit === V && i(e, N, "")
            }
            r(e, G) && e$({effect: ej, actionTypeId: a, elementApi: n})(e)
        }
        ...
        function eY(e) {
            ...
            return e.forEach((e, i) => {
                let {config: r} = e, a = r.delay + r.duration;
                a >= t && (t = a, n = i)
            }), n
        }
        ...
        function eq(e, t) {
            ...
            return n.forEach((e, t) => {
                if (i && 0 === t) return;
                let {actionItems: n} = e, l = n[eY(n)], {config: c, actionTypeId: s} = l;
                r.id === l.id && (u = o + a);
        ...
        function eQ({actionList: e, actionItemId: t, rawData: n}) {
            let {actionItemGroups: i, continuousParameterGroups: r} = e, a = [],
                o = e => (a.push((0, l.mergeIn)(e, ["config"], {delay: 0, duration: 0})), e.id === t);
            return i && i.some(({actionItems: e}) => e.some(o)), r && r.some(e => {
                let {continuousActionGroups: t} = e;
                return t.some(({actionItems: e}) => e.some(o))
            }), (0, l.setIn)(n, ["actionLists"], {[e.id]: {id: e.id, actionItemGroups: [{actionItems: a}]}})
        }
        ...
        } = o.IX2EngineActionTypes, b = {}, _ = (e = b, t = {}) => {
            switch (t.type) {
                case y:
                    return b;
                case v: {
                    let {
                        ...
                        actionItem: o,
                        refType: u
                    } = t.payload, {actionTypeId: l} = o, c = e;
                    return (0, a.getIn)(c, [n, i]) !== i && (c = T(c, i, u, n, o)), O(c, n, l, r, o)
                }
                case I: {
        ...
        Webflow.require("ix").init([{
            ...
            value: {
                ...
                triggers: [{
                    ...
                    stepsA: [{
                        ...
                        display: "block",
                        opacity: 1,
                        transition: "transform 250ms ease-out 0, opacity 300ms ease-out 0",
                        x: "0px",
                        y: "0px",
                        z: "0px"
                    }],
            ...
            events: {
                "e-3": {
                    ...
                    target: {
                        selector: ".navbar-trigger-zone",
                        originalId: "5dfe9069e65e06bee7d15121|a3c40e1a-ad08-a45c-f3ff-b7b49b2f043c",
                        appliesTo: "CLASS"
                    },
                    targets: [{
                        selector: ".navbar-trigger-zone",
                ...
                "e-5": {
                    ...
                    target: {
                        ...
                        originalId: "5dfe9069e65e06ab55d1513e|da75f35c-f028-3cbe-8af5-8607143a2058",
                        appliesTo: "CLASS"
                    },
                    targets: [{
                        selector: ".case-study-image",
                ...
                "e-7": {
                    ...
                    target: {
                        ...
                        originalId: "4f65440f-60e4-a80f-fa52-59c81ba9966b",
                        appliesTo: "CLASS"
                    },
                    targets: [{
                        selector: ".contact-field",
                ...
                "e-10": {
                    ...
                    mediaQueries: ["main", "medium", "small", "tiny"],
                    target: {
                        id: "5dfe9069e65e06ab55d1513e|11662ead-e6c0-79f9-7928-11e1c44309d1",
                        appliesTo: "ELEMENT",
                        styleBlockIds: []
                    },
                    targets: [{
                ...
                "e-12": {
                    ...
                    mediaQueries: ["main", "medium", "small", "tiny"],
                    target: {id: "5dfe9069e65e06ab55d1513e", appliesTo: "PAGE", styleBlockIds: []},
                    targets: [{id: "5dfe9069e65e06ab55d1513e", appliesTo: "PAGE", styleBlockIds: []}],
                    config: [{
                ...
                "e-13": {
                    ...
                    target: {
                        selector: ".contact-field",
                        originalId: "5dfe9069e65e06ab55d1513e|c81b766c-268f-0611-cdff-eb70ec28b735",
                        appliesTo: "CLASS"
                    },
                    targets: [{
                        selector: ".contact-field",
                ...
                "e-15": {
                    ...
                    mediaQueries: ["main", "medium", "small", "tiny"],
                    target: {
                        id: "5dfe9069e65e066f0ed15140|2e52e458-99fd-f1ad-42f3-96d60e174478",
                        appliesTo: "ELEMENT",
                        styleBlockIds: []
                    },
                    targets: [{
                ...
                "e-17": {
                    ...
                    target: {
                        ...
                        originalId: "5dfe9069e65e066f0ed15140|21f02e04-df36-8bac-238b-8346be1fd412",
                        appliesTo: "CLASS"
                    },
                    targets: [{
                        selector: ".accordion-item-trigger",
            ...
            actionLists: {
                    ...
                    actionItemGroups: [{
                        actionItems: [{
                            ...
                            config: {
                                ...
                                easing: "outExpo",
                                duration: 300,
                                target: {id: "daf909ee-90f0-572f-dc78-3f751d66582b"},
                                yValue: 0,
                                xUnit: "PX",
                                yUnit: "PX",
                                zUnit: "PX"
                        ...
                        actionItems: [{
                            ...
                            config: {
                                ...
                                target: {
                                    ...
                                    selector: ".case-study-image",
                                    selectorGuids: ["0208610f-dbb9-29f2-1822-68b360c8c080"]
                                },
                                yValue: 75,
                                xUnit: "PX",
                                yUnit: "PX",
                ...
                "a-5": {
                    ...
                    actionItemGroups: [{
                        actionItems: [{
                            ...
                            config: {
                                ...
                                duration: 500,
                                target: {
                                    selector: ".background-video.contact",
                                    selectorGuids: ["c338c3bb-79da-74db-a8db-a541e8078a09", "e1483cdf-9d46-02d4-1872-ec9a151c81be"]
                                },
                                globalSwatchId: "",
                                rValue: 0,
                                bValue: 0,
                    ...
                    useFirstGroupAsInitialState: !0,
                    createdOn: 0x16f1d25da42
                },
                "a-7": {
                    id: "a-7",
                    title: "Text Scale - Hover In",
                    actionItemGroups: [{
                        actionItems: [{
                            id: "a-7-n",
                            ...
                            config: {
                                ...
                                target: {
                                    ...
                                    id: "5dfe9069e65e06ab55d1513e|34d6b009-7068-05b5-c6d9-03e959e731e1"
                                },
                                locked: !0
                            }
                        }]
                    ...
                    useFirstGroupAsInitialState: !0,
                    createdOn: 0x16f273217ee
                },
                "a-8": {
                    id: "a-8",
                    title: "Text Scale - Hover Out",
                    actionItemGroups: [{
                        actionItems: [{
                            id: "a-8-n-2",
                            actionTypeId: "TRANSFORM_SCALE",
                ...
                "a-6": {
                    id: "a-6", title: "Back To Top Slide", continuousParameterGroups: [{
                        id: "a-6-p",
                        ...
                        continuousActionGroups: [{
                            ...
                            actionItems: [{
                                ...
                                config: {
                                    ...
                                    easing: "ease",
                                    duration: 500,
                                    target: {id: "5dfe9069e65e06ab55d1513e|cf179ef4-ef97-5282-9c6f-73fad5b87da7"},
                                    xValue: -8,
                                    xUnit: "VW",
                                    yUnit: "PX",
                                    zUnit: "PX"
                    ...
                    }], createdOn: 0x16f223b8f09
                },
                "a-9": {
                    id: "a-9",
                    title: "Fade to Dark 2",
                    actionItemGroups: [{
                        actionItems: [{
                            id: "a-9-n",
                            actionTypeId: "STYLE_BACKGROUND_COLOR",
                        ...
                        actionItems: [{
                            ...
                            config: {
                                ...
                                target: {
                                    ...
                                    selectorGuids: ["020cdee4-0926-c176-9fcb-cb080c558ab2"]
                                },
                                zValue: 0,
                                xUnit: "DEG",
                                yUnit: "DEG",
                ...
                "a-15": {
                    id: "a-15",
                    title: "Accordion v2 close title swap",
                    actionItemGroups: [{
                        actionItems: [{
                            id: "a-15-n",
                            actionTypeId: "STYLE_SIZE",
                            config: {
                                ...
                                target: {
                                    ...
                                    selectorGuids: ["dc7fc530-d4f7-5b96-58b6-6763947be7f0"]
                                },
                                heightValue: 0,
                                widthUnit: "PX",
                                heightUnit: "PX",
                            ...
                            config: {
                                ...
                                target: {
                                    ...
                                    selectorGuids: ["2772c875-1d10-ccc1-b75b-87fe98febcb7"]
                                },
                                zValue: -90,
                                xUnit: "DEG",
                                yUnit: "DEG",
                            ...
                            config: {
                                delay: 0,
                                easing: [.684, -.005, .38, 1.001],
                                duration: 250,
                                target: {id: "5dfe9069e65e06ab55d1513e|903154b6-56bc-2380-a10d-d5605fac4e7c"},
                                yValue: -1.6,
                                xUnit: "PX",
                                yUnit: "em",
                                zUnit: "PX"
